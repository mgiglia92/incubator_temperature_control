/*
TempControl is a class that will handle controlling the temperature of the incubator.
...
class TempControl:public PIDControl{

    public:
//Constructor
    TempControl(struct PID_Initializer p):PIDControl(p)
    {   
        ledPin = 13;
        // wdt_enable(WDTO_4S);
        // wdt_reset();
